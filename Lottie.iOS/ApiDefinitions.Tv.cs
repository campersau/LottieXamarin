...
namespace Airbnb.Lottie
{
	...
	interface CompatibleAnimation
	{
		...
		// +(CompatibleAnimation * _Nonnull)animationFromURL:(NSURL * _Nonnull)url __attribute__((warn_unused_result));
		[Static]
		[Export ("animationFromURL:")]
		CompatibleAnimation AnimationFromURL (NSUrl url);
